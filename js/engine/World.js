...
export class World {
  ...
  _biomeAndHeightAt(wx, wz) {
    ...
    // smaller amplitude than Forest's jagged hills. Plains/Desert: flat,
    // open ground. Lake: capping depth keeps lakebeds shallow instead of
    // letting some lakes plunge down into true cave territory.
    let heightSample = h;
    let amplitude = 24;
