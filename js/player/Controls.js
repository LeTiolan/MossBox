...
export class Controls {
  constructor(camera, domElement, world) {
    ...
    // Spawn exactly 2 blocks above the real ground at (0,0) instead of a
    // hardcoded height — the old fixed y=90 could be far above or even
    // below the actual terrain there depending on what noise generated
    // at that spot, causing either a huge fall on spawn or spawning
    // inside solid ground.
    const spawnSurfaceY = world.getSurfaceHeightAt(0, 0) ?? 70;
    this.position = new THREE.Vector3(0, spawnSurfaceY + 2, 0);
