...
export const BLOCKS = {
  ...
  stone:      { id: 3,  name: 'Stone',      color: '#8a8a8f', solid: true,  requiresTool: 'wood_pickaxe', drops: 'cobblestone', texture: 'stone' },
  cobblestone:{ id: 4,  name: 'Cobblestone',color: '#767679', solid: true,  requiresTool: 'wood_pickaxe', texture: 'cobblestone' },
  ...
  leaves:     { id: 13, name: 'Leaves',     color: '#3f7a34', solid: true,  transparent: true, opacity: 0.92, drops: 'apple', texture: 'leaves' },
  ...
  coal_ore:   { id: 23, name: 'Coal Ore',   color: '#4a4a4a', solid: true,  requiresTool: 'wood_pickaxe', drops: 'coal', texture: 'coal_ore' },
